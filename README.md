...
## Admin-App (Internal Use Endpoints Only) <a name="admin"></a>

#### Manually Scan File (DO NOT USE)
Manually scan a file if it was unsuccessfully scanned on the first attempt.
