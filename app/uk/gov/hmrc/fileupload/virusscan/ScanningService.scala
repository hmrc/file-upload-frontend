...
object ScanningService:
  ...
  enum ScanError:
    case ScanResultVirusDetected                       extends ScanError
    case ScanReadCommandTimeOut                        extends ScanError
    case ScanResultFailureSendingChunks(ex: Throwable) extends ScanError
    case ScanResultUnexpectedResult                    extends ScanError
    case ScanResultError(ex: Throwable)                extends ScanError
  ...
  private def retries(
    ...
    scanResult.flatMap:
      ...
      case Left(ScanError.ScanReadCommandTimeOut) =>
  ...
  private def scan(
    ...
    file.flatMap:
      ...
      case Left(e)     => Future.successful(Left(ScanError.ScanResultError(Exception(e.getClass.getSimpleName))))
